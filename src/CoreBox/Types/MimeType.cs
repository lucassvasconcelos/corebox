...
public static class MimeType
{
    ...
    public static string mid => "audio/midi audio/x-midi";
    public static string midi => "audio/midi audio/x-midi";
    ...
    public static string audio3gp => "audio/3gpp";
    public static string video3gp => "video/3gpp";
    public static string audio3g2 => "audio/3gpp2";
    public static string video3g2 => "video/3gpp2";
    public static string archive7z => "application/x-7z-compressed";
}