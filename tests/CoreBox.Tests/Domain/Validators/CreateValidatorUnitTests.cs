...
public class CreateValidatorUnitTests
{
    ...
    {
        Action act = () => Validation.Criar(id, dataCriacao, idUsuarioCriacao, dataUltimaAtualizacao, idUsuarioAtualizacao, foiExcluido, dataExclusao, idUsuarioExclusao, doSoftDeleteValidations);
