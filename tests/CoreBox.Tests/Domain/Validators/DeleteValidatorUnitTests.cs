...
public class DeleteValidatorUnitTests
{
    ...
    public static readonly object[][] TestData =
    {
        ...
        new object[] { ValidEntity, "", false, Guid.NewGuid(), DateTime.UtcNow, Guid.NewGuid(), DateTime.UtcNow, Guid.NewGuid(), true, null, null, "..." },
        new object[] { ValidEntity, "", false, Guid.NewGuid(), DateTime.UtcNow, Guid.NewGuid(), DateTime.UtcNow, Guid.NewGuid(), true, null, null, "..." },
        new object[] { ValidEntity, "Campo obrigatório!", true, Guid.NewGuid(), DateTime.UtcNow, Guid.NewGuid(), null, null, true, DateTime.UtcNow, Guid.NewGuid(), "" }
    };
    ...
    {
        Action act = () => entity.Deletar(id, dataCriacao, idUsuarioCriacao, dataUltimaAtualizacao, idUsuarioAtualizacao, foiExcluido, dataExclusao, idUsuarioExclusao, doSoftDeleteValidations, campoObrigatorio);
