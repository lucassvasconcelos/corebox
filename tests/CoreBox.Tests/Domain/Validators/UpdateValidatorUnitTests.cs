...
public class UpdateValidatorUnitTests
{
    ...
    public static readonly object[][] TestData =
    {
        ...
        new object[] { ValidEntity, "Campo obrigatório!", true, Guid.NewGuid(), DateTime.UtcNow, Guid.NewGuid(), DateTime.UtcNow, Guid.NewGuid(), false, null, null, "" }
    };
    ...
    {
        Action act = () => entity.Atualizar(id, dataCriacao, idUsuarioCriacao, dataUltimaAtualizacao, idUsuarioAtualizacao, foiExcluido, dataExclusao, idUsuarioExclusao, doSoftDeleteValidations, campoObrigatorio);
